...
export async function GET(
  ...
  logAudit({ userId: user.id, email: user.email ?? undefined, role: user.app_metadata?.role ?? user.user_metadata?.role, action: 'view_result', resourceType: 'lab_result', resourceId: params.id, patientId: data.patient_id }, request)
